#include <cs50.h>
#include <stdio.h>
#include <string.h> // requried to compare strings, strcmp()
...
void sort_pairs(void)
{
    for (int i = 0; i < pair_count; i++)
    {
        ...
        for (int j = 0; j < pair_count - i - 1; j++) // Bubble sort algorithm
        {
            ...
            int s_pair1 = preferences[i1][j1] - preferences[j1][i1]; // first pair strength

            int i2 = pairs[j + 1].winner;
            int j2 = pairs[j + 1].loser;

            int s_pair2 = preferences[i2][j2] - preferences[j2][i2]; // second pair strength
